...
t_material	sphere_1_mat(void)
{
	return ((t_material){
		...
		.pattern.colour = stripe_pattern(hex_to_argb(COLOUR_BLUE),hex_to_argb(COLOUR_WHITE)),
...
t_material	floor_mat(void)
{
	return ((t_material){
		...
		.shininess = 200,
		.pattern.type = PATTERN_STRIPE,
		.pattern.colour = stripe_pattern(hex_to_argb(COLOUR_YELLOW),hex_to_argb(COLOUR_PURPLE)),
...
t_material	left_wall_mat(void)
{
	return ((t_material){
		...
		.shininess = 200,
		.pattern.type = PATTERN_STRIPE,
		.pattern.colour = stripe_pattern(hex_to_argb(COLOUR_RED),hex_to_argb(COLOUR_GREEN)),
...
t_material	right_wall_mat(void)
{
	return ((t_material){
		...
		.shininess = 200,
		.pattern.type = PATTERN_STRIPE,
		.pattern.colour = stripe_pattern(hex_to_argb(COLOUR_TURQOUISE),hex_to_argb(COLOUR_WHITE)),
