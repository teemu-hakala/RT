...
t_tuple	refracted_colour(t_world *world, t_hit *hit)
{
	...
	world->refracted_ray.direction = \
		normalize(tuple_sub(tuple_scale(hit->computations.vectors.surface_normal, \
...
t_fl	schlick(t_hit *hit)
{
	...
	t_fl	reflectance;
	// t_fl	temp;
	// if (hit->computations.inside == true)
	// {
	// 	temp = hit->computations.n1;
	// 	hit->computations.n1 = hit->computations.n2;
	// 	hit->computations.n2 = temp;
	// }
